...
<?php
// do not alllow the user to access register page after resgistering 
...
if (isset($_GET['id'])) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if (
      empty($_POST['name']) or empty($_POST['phone_number']) or empty($_POST['num_of_guests'])
      ...
      VALUES (:name, :phone_number, :num_of_guests, :checkin_date, :destination, :status,
