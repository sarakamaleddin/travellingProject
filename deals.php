            ...
            <div class="col-lg-4">
              <fieldset>
                <select name="price" class="form-select" aria-label="Default select example" id="choosePrice" onChange="this.form.click()">
                  ...
                  <option value="100">Lesss than $100</option>
                  <option value="250">Lesss than $250</option>
                  <option value="500">Lesss than $500</option>
                  <option value="1000">Lesss than $1,000</option>
                  <option value="2500">Lesss than $2,500</option>
                </select>
              </fieldset>
            </div>
            <div class="col-lg-2">
